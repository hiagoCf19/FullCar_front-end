...
const FinalLayout = () => {
  return (<div className="  w-full  justify-center flex items-center flex-col space-y-4 h-[60vh]">
    ...
    <p className="text-center text-lg">Agora você pode acompanhar as novidades sobre o seu anuncio em <Link className="underline text-primary text-lg" href={"/meus-anuncios"}>
      meus anuncios </Link>
    </p>
  </div>);
}
